...
function hasReturnType(signature) {
    return /\)\s*:\s*\S/.test(signature);
}
function extractExtendsName(signature) {
...
class ClaimsEngine {
    ...
    generateAndStoreClaimsBatch(symbols) {
        const allClaims = [];
    ...
    getClaimsForSymbol(symbolId) {
        return this.db.getClaimsBySymbolId(symbolId);
    }
    invalidateClaimsForSymbol(symbolId) {
        this.db.deleteClaimsBySymbolId(symbolId);
    }
}
exports.ClaimsEngine = ClaimsEngine;
//# sourceMappingURL=claims-engine.js.map