...
exports.RollbackHeuristics = void 0;
class RollbackHeuristics {
    /**
     ...
     */
    decide(signals, affectedArtifacts, failureSeverity) {
        const errorSignals = signals.filter(s => (s.signalType === 'test' || s.signalType === 'build' || s.signalType === 'typecheck') &&
            s.status === 'failure');
...
exports.RollbackHeuristics = RollbackHeuristics;
//# sourceMappingURL=RollbackHeuristics.js.map